...
hang = ["""
H A N G M A N - GUESS THE CHOCOLATE HIDDEN
...
def getRandomWord():
    words = ['dairymilk', 'perk', 'fuse', 'fivestar', 'kitkat', 'milkybar', 'melody', 'eclairs',
             'milkyway', 'mars', 'twix', 'ferrerorocher', 'coffeebite', 'lactoking', 'Toblerone', 'munch', 'crispello']
